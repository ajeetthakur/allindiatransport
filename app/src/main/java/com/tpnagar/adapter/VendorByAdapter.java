...
import com.tpnagar.fragment.VendorByListFragment;
...
public class VendorByAdapter extends BaseAdapter {
    ...
    VendorByListFragment mvendorByListFragment;
    public VendorByAdapter(Activity context, ArrayList<VendorCompanyWrapper> list, FragmentTransaction fragmentTransaction, VendorByListFragment vendorByListFragment  ) {
        mContext = context;
        mList = list;
        mvendorByListFragment=vendorByListFragment;
...
/*
    ...
    private void hideShowRequest(JSONObject params) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Const.URL_HIDENSHOWVENDOR,
                params, newResponseRequesrtpostedvehicledelete(), eErrorListenerRequesrtpostedvehicledelete()) {
            @Override
            public String getBodyContentType() {
                return "application/json; charset=utf-8";
                ...
                try {
                    ...
                    if (StatusValue.equalsIgnoreCase("Success")) {
                       ...
                       // mContext.onBackPressed();
                        mvendorByListFragment.updateMethod();
