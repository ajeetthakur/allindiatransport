...
public class VendorBranchAdapter extends BaseAdapter {
    ...
    public VendorBranchAdapter(Activity context, ArrayList<VendorCompanyWrapper> list, FragmentTransaction fragmentTransaction) {
        mContext = context;
        mList = list;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (Role_Idint<4){
            ...
            viewHolder.hide_show.setVisibility(View.VISIBLE);
        ...
        viewHolder.hide_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!viewHolder.hide_show.isChecked()) {



                    JSONObject obj = new JSONObject();
                    try {
                        SharedPreferences prefs = mContext.getSharedPreferences("com.tpnagar", Context.MODE_PRIVATE);
