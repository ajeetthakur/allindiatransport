...
import com.tpnagar.fragment.NotificationBlockCompanyListFragment;
...
public class NotificationBlockCompanyAdapter extends BaseAdapter {
    ...
    NotificationBlockCompanyListFragment  notificationCompanyListFragment;
    public NotificationBlockCompanyAdapter(Activity context, ArrayList<NotificationCompnay> list, FragmentTransaction fragmentTransaction, NotificationBlockCompanyListFragment   notificationCompanyListFragment  ) {
        mContext = context;
        mList = list;
...
ImageView image_profile,more;
        public CompleteListViewHolder(View base) {
           ...
           more = (ImageView) base.findViewById(R.id.more);
