...
public class ServicesListForBranchFragment extends BaseContainerFragment {
   ...
   // EditText txtContact;
    ...
    private void serviceServicrlistRequest(JSONObject params) {
      String  idbranch=getArguments().getString("id");

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Const.URL_GetCompanyService+idbranch,
