 ...
 */
public class PostVehiclesMainFragment extends BaseContainerFragment {
    private int splashTimeOut = 3000;
    private LinearLayout splashLayout;
    SharedPreferences prefs = null;
    ConnectionDetector cd;
    //ImageButton search;
   TextView addbranch,viewlist;
    View rootView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.vehiclesmain, container, false);
        return rootView;
    }
    ...
    private void initXmlViews(View view) {
        ...
        addbranch=(TextView) view.findViewById(R.id.addVehicle);
        ...
        addbranch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PostVehicleFragment fragmentGood = new PostVehicleFragment();
                Bundle args = new Bundle();

                args.putString("Where", "FragmentADD");
                fragmentGood.setArguments(args);

                replaceFragmentTask(fragmentGood);
        ...
        viewlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragmentTask(new PostVehiclesListFragment());
