...
import com.tpnagar.adapter.VendorAdapter;
...
public class VendorListFragment extends BaseContainerFragment {
  ...
  public void updateMethod(){
    ...
    private void initXmlViews(View view) {
        ...
        ((com.tpnagar.designdemo.MainActivity) getActivity())
                .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"My Vendor List" + "</font>")));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
...

                    {
                        ...
                        VendorAdapter mListAdapter = new VendorAdapter(getActivity(), vendorCompanyWrapperlist,transaction,VendorListFragment.this);
