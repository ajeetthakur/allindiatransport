 ...
 */
public class PostGoodsFragment extends BaseContainerFragment {
    ...
    void addpostedgoodsApi(){
     ...
     /*   {
        ...
        try {
            ...
            obj.put("To_City_Name",  txtto_city.getText().toString());

            obj.put("From_City_Name",  txtfrom_city.getText().toString());

           // To_City_Name":"Begusarai",
           // "From_City_Name":"Ghaziabad",
