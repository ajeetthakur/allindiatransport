 ...
 */
public class AddServiceFragment extends BaseContainerFragment {
   ...
   @Override
    ...
    private void initXmlViews(View view) {
        ...
        ((com.tpnagar.designdemo.MainActivity) getActivity())
                .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Add Services" + "</font>")));
        ...
        TextView   state=(TextView) view.findViewById(R.id.txtFrom_state);
        TextView  city=(TextView) view.findViewById(R.id.txtFrom_city);
        prefs = getActivity().getSharedPreferences("com.tpnagar", MODE_PRIVATE);

        city.setText(prefs.getString("City_Name",""));
        state.setText(prefs.getString("State_Name",""));
