 ...
 */
public class PostGoodsMainFragment extends BaseContainerFragment {
   ...
   TextView addbranch,viewlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.goodsmain, container, false);
        return rootView;
    }
    ...
    private void initXmlViews(View view) {
        ...
        addbranch=(TextView) view.findViewById(R.id.addgoods);
        ...
        viewlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                replaceFragmentTask(new PostGoodsListFragment());
