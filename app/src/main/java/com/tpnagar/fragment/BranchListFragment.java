...
import com.tpnagar.adapter.BranchAdapter;
import com.tpnagar.adapter.BranchViewOnlyAdapter;
...
public class BranchListFragment extends BaseContainerFragment {
   ...
   // EditText txtContact;
    ...
    private void initXmlViews(View view) {
        ...
        ((com.tpnagar.designdemo.MainActivity) getActivity())
                .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Branch List" + "</font>")));

        rel_main_top= view.findViewById(R.id.rel_main_top);
