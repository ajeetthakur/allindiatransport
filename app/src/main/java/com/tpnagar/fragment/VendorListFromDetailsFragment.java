...
import com.tpnagar.adapter.VendorFromDetailsAdapter;
...
public class VendorListFromDetailsFragment extends BaseContainerFragment {
   ...
   // EditText txtContact;
    ...
    private void initXmlViews(View view) {
        ...
        if(prefs.getString("IsActive","").equalsIgnoreCase("yes"))
        {
            ((com.tpnagar.designdemo.MainActivity) getActivity())
                    .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Company Vendor List" + "</font>")));
    ...
    private void vendorlistRequest(JSONObject params) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Const.URL_SHOWACTIVEVENDOROFCOMPANY,
                ...
                try {
...

                    {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                          ...
                          if(obj.getBoolean("Hide_By_Company")){
                        ...
                        VendorFromDetailsAdapter mListAdapter = new VendorFromDetailsAdapter(getActivity(), vendorCompanyWrapperlist,transaction);
