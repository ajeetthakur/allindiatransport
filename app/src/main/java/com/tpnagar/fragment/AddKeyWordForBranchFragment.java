 ...
 */
public class AddKeyWordForBranchFragment extends BaseContainerFragment {

    SharedPreferences prefs = null;
    ConnectionDetector cd;
    TextView textservice,textkeyword,keywordtextshow,save,viewlist;
    String stringCompany_Service_Id="",stringService_Keyword_Id="",stringKeyword ="",stringserviceId="",stringCompanyMain="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.add_keyword_forbranch, container, false);
        return rootView;
    }
    ...
    private void initXmlViews(View view) {
        ...
        ((com.tpnagar.designdemo.MainActivity) getActivity())
                .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Add Branch Keywords" + "</font>")));
        ...
        TextView continue_text=(TextView) view.findViewById(R.id.continue_text);
       /* if(AppController.ToComefromEdit.equalsIgnoreCase("yes")){
            continue_text.setVisibility(View.GONE);
            checkBox1.setVisibility(View.GONE);
        }else{
            checkBox1.setVisibility(View.VISIBLE);
            continue_text.setVisibility(View.VISIBLE);
        }
*/
        continue_text.setVisibility(View.VISIBLE);
        continue_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("id",idbranch);

                LoginBranchFaragment searchListFragment=new LoginBranchFaragment();
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                       ...
                       // StringBuilder stringBuilderstringKeyword= new StringBuilder();
                            ...
                            if (checked) {
                                ...
                                for (int j = 0; j < getlist.size(); j++) {
                                    ...
                                    if(getlist.get(j).getKeyword().equalsIgnoreCase(list.getItemAtPosition(i).toString())){
                                        ...
                                        stringBuilderCompany_Service_Id.append(getlist.get(i).getCompany_Service_Id()+"~"+getlist.get(i).getService_Keyword_Id()+"~"+getlist.get(i).getKeyword());
                        ...
                        if (stringBuilder.toString().trim().equals("")) {
                            ...
                            stringCompany_Service_Id=stringBuilderCompany_Service_Id.toString();
