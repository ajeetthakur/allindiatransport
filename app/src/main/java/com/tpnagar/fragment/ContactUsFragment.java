 ...
 */
public class ContactUsFragment extends BaseContainerFragment {
    ...
    void addEnquiry(){
        ...
        try {
            ...
            obj.put("Company_Name", prefs.getString("Company_Name",""));
            ...
            obj.put("Enquiry", txtDesc.getText().toString());
    ...
    private void addbranchRequest(JSONObject params) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Const.URL_addcontactus,
