 ...
 */
public class AddServiceForBranchFragment extends BaseContainerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.add_serviceforbranch, container, false);
        return rootView;
    }
...
/*    @Override
    ...
    private void initXmlViews(View view) {
        ...
        ((com.tpnagar.designdemo.MainActivity) getActivity())
                .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Add Branch Services" + "</font>")));
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (stringBuilder.toString().trim().equals("")) {
                            ...
                            citytextshow.setText("Selected cities:- "+stringBuilder);
                        }
                    }
                });
