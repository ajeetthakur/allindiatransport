...
import com.tpnagar.adapter.NotificationBlockCompanyAdapter;
...
public class NotificationBlockCompanyListFragment extends BaseContainerFragment {
    ...
    private void initXmlViews(View view) {
        ...
        if(prefs.getString("IsActive","").equalsIgnoreCase("yes"))
        {
            ((com.tpnagar.designdemo.MainActivity) getActivity())
                    .getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" +"Block Companies" + "</font>")));
    ...
    void getNotificationList(){
       ...
       String Company_Id=prefs.getString("Company_Id","");
            ...
            notificationListRequest(obj,Company_Id);
    ...
    private void notificationListRequest(JSONObject params,String Company_Id) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Const.URL_getblockedcompanylist+Company_Id,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (StatusValue.equalsIgnoreCase("Success")) {
                        ...
                        NotificationBlockCompanyAdapter mListAdapter = new NotificationBlockCompanyAdapter(getActivity(), notificationsWrappers,transaction,NotificationBlockCompanyListFragment.this);
